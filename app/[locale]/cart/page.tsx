...
import { imageReturn, parsedDevise } from "@/lib/utils";
...
const CartPage: React.FC = () => {
  ...
  const { carts, removeFromCart, updateToCart } = useStore();
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
        <div className="lg:flex gap-8 p-6 lg:p-8">
          ...
          <div className="lg:w-1/3 bg-indigo-600 p-6 rounded-2xl lg:sticky lg:top-8 self-start">
            ...
            <button className="w-full bg-green-400 text-indigo-800 py-4 rounded-xl font-semibold text-lg hover:bg-green-300 transition-colors flex items-center justify-center">
              <span>
                {total.toFixed(2)} {parsedDevise(carts[0]?.currency)}
              </span>
