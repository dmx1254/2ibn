  ...
  return (
    <div className="space-y-6">
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#0A7CFF] hover:bg-[#006AFF] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 flex items-center gap-2"
