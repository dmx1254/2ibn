      ...
      {[1, 2, 3].map((i) => (
        <React.Fragment key={i}>
          ...
          {i < 3 && (
            <div
              className={`w-20 h-1 ${
                step > i ? "bg-yellow-500" : "bg-gray-300"
              }`}
            />
          )}
        </React.Fragment>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              id="lastname"
              name="lastname"
              className="pl-10 outline-none bg-transparent border-gray-400 text-black focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-gray-500"
    ...
    <div className="w-full space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input
          id="code"
          name="code"
          className="text-center bg-transparent border-gray-400 text-black text-2xl tracking-widest outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-black/45 px-4 py-6"
    ...
    <div className="w-full space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              id="country"
              name="country"
              className="pl-10 outline-none bg-transparent text-black border-gray-400 placeholder:text-gray-500 focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={handleChange}
          className="outline-none bg-transparent text-black border-gray-400 placeholder:text-gray-500 focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
        />
        {postalCodeError && (
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <button className="text-white">{tScope2("signup")}</button>
      </DialogTrigger>
