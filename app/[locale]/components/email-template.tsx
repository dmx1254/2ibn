        ...
        <td style={{ padding: "0 30px 30px" }}>
          ...
          >
            ...
            >
              ...
              <br />
              Ne partagez jamais ce code avec qui que ce soit. L'équipe 2IBN ne
              vous demandera jamais votre code de vérification.
            </p>
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td style={{ textAlign: "center", color: "#999999", fontSize: "12px" }}>
          <p>
            ...
            emails, ajoutez verification@2ibn.com à votre liste de contacts.
          </p>
        </td>
      </tr>
    </table>
