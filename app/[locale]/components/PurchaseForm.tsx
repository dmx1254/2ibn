      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <Card className="bg-[#363A3D] border-none p-6 rounded-xl">
            ...
            <Card className="bg-[#363A3D] border-none p-6 rounded-xl sticky top-6">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center py-3 border-b border-[#45494e]">
                  <span className="text-[#a1a0a0]">{tScope("homeServer")}</span>
                ...
                <button
                  ...
                  className={clsx(
                    "w-full flex items-center justify-center gap-2 bg-yellow-500 text-white rounded-xl text-lg font-medium p-4 transition-all",
                    {
