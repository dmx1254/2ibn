  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const result = await axios.post(
        `${process.env.NEXT_PUBLIC_IBENDOUMA_CLIENT_URL}/order`,
        data
      );
      if (result.data) {
        toast.success(
        ...
        <div className="lg:flex gap-8 p-6 lg:p-8">
          <div className="lg:w-2/3 mb-8 lg:mb-0">
            ...
            <p className="text-sm text-gray-500 mb-6">
              You have {carts.length} item{carts.length !== 1 ? "s" : ""} in
              your cart
            </p>
          ...
          <div className="lg:w-1/3 bg-indigo-600 p-6 rounded-2xl lg:sticky lg:top-8 self-start">
            ...
            <div className="mb-6">
              <p className="text-sm text-indigo-200 mb-3">Payment methods</p>
            ...
            <button
              ...
              disabled={total <= 0 || isOrderLoading}
            >
              {isOrderLoading ? (
